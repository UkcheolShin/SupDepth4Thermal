...
class ACVNetModel(nn.Module):
    def __init__(self, maxdisp, attn_weights_only, freeze_attn_weights, pre_trained=False, ckpt_path=''):
        super(ACVNetModel, self).__init__()
